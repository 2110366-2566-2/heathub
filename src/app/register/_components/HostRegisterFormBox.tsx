...
export default function RegisterFormBox(props: RegisterFormBoxProps) {
  ...
  return (
    <Card className="h-[964px] w-full min-w-[256px] max-w-[600px] justify-center self-center rounded-3xl border-solid border-primary-500 bg-white md:h-[496px] md:max-w-[844px]">
