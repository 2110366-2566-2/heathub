        ...
        <div className="h-max-[128px] flex h-fit w-full flex-row gap-x-6 lg:h-[124px]">
          <div className="flex h-full w-full flex-row gap-4">
            ...
            <div className="flex h-fit w-full flex-col gap-y-2">
              <div className="h3 font-bold text-purple-900">{`${name}, ${age}`}</div>
              <div className="flex h-fit w-full flex-col gap-y-1">
                <div className="h5 flex h-6 flex-row items-center gap-x-1 truncate text-medium">
                  <div className="flex h-[18px] flex-row items-center gap-x-2">
                    <div className="truncate">{firstName}</div>
                    <div className="hidden sm:flex">{lastName}</div>
                  </div>
                  <div className="hidden sm:flex">•</div>
                  <div className="hidden h-[18px] flex-row items-center gap-x-2 sm:flex">
                    <div>{gender}</div>
                  </div>
                </div>
                <div className="h5 line-clamp-3 w-full text-placeholder lg:line-clamp-2">
                  {about}
                </div>
              </div>
            </div>
