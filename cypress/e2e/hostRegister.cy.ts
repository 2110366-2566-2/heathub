...
describe("Host Register", () => {
  ...
  it("TC1-1: Valid Register", () => {
    ...
    HandlerEmailandPassword(`host${random}@gmail.com`, "12345678", "12345678");
  ...
  it("TC1-10: Confirm password does not match the filled password", () => {
    const random = Math.floor(Math.random() * 1000000);
    HandlerEmailandPassword(`host${random}@gmail.com`, "12345678", "123456789");
  ...
  it("TC1-20: Date of birth is later than the present", () => {
    ...
    cy.get("input[name='Firstname']", { timeout: 1000 }).type(`host${random}`);
